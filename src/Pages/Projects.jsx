...
function Projects() {
  ...
  Lifestyle E-Commerce Web App
          ...
          <Grid item   xs={12} md={10}>
            ...
            >
Built a fully functional lifestyle e-commerce website using React.js, designed to deliver a seamless shopping experience. The platform includes category-based browsing (Men, Women, Bags&Shoe,BeautyProducts), product filtering by price and name, and a dynamic search feature for easy navigation. Integrated React's useContext to manage a global cart state, allowing users to add and view products from anywhere in the app. The UI is responsive and user-friendly, optimized for both desktop and mobile views. This project highlights key features like product display, filtering, and real-time cart updates, simulating a real online store environment.            </Typography>
